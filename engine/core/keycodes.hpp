...
enum mod_keys
{
    MODKEY_NONE = KMOD_NONE,
    MODKEY_LSHIFT = KMOD_LSHIFT,
    MODKEY_RSHIFT = KMOD_RSHIFT,
    MODKEY_LCTRL = KMOD_LCTRL,
    MODKEY_RCTRL = KMOD_RCTRL,
    MODKEY_LALT = KMOD_LALT,
    MODKEY_RALT = KMOD_RALT,
    MODKEY_LGUI = KMOD_LGUI,
    MODKEY_RGUI = KMOD_RGUI,
    MODKEY_NUM = KMOD_NUM,
    MODKEY_CAPS = KMOD_CAPS,
    MODKEY_MODE = KMOD_MODE,
    MODKEY_RESERVED = KMOD_RESERVED,
    MODKEY_CTRL = KMOD_CTRL,
    MODKEY_SHIFT = KMOD_SHIFT,
    MODKEY_ALT = KMOD_ALT,
    MODKEY_GUI = KMOD_GUI,
};
